...
public class MaasHesaplama {
    public static void main(String[] args) {
        ...
        String name;
        int salary,workHours,hireyears;

        System.out.println("Adınızı giriniz:");
        name=girdi.nextLine();

        System.out.println("Maaşınızı giriniz:");
        salary=girdi.nextInt();

        System.out.println("Çalışma saatini giriniz:");
        workHours=girdi.nextInt();

        System.out.println("İşe başlama yılınızı giriniz:");
        hireyears=girdi.nextInt();

        Employee x= new Employee(name,salary,workHours,hireyears);
