...
public class UcakBileti {
    public static void main(String[] args) {
        ...
        float normalFiyat,indirimliFiyat,yasIndirimi,tipIndirimi,tutar;
        ...
        if(yas<0){
            ...
            if(yolculukTipi!=1 && yolculukTipi!=2){
                ...
                if(km<0){
                    ...
                    normalFiyat = (float) (km*0.10);
                    if(yas<12){
                        yasIndirimi = ((float) (normalFiyat * 0.5));
                        indirimliFiyat = normalFiyat - yasIndirimi;
                    }
                    else if (yas>=12 && yas<24 ) {
                        yasIndirimi = (float) (normalFiyat * 0.10);
                        indirimliFiyat = normalFiyat - yasIndirimi;
                    }
                    else if(yas>65){
                        yasIndirimi = (float) (normalFiyat * 0.30);
                        indirimliFiyat = normalFiyat - yasIndirimi;
                    }
                    else{
                    ...
                    if(yolculukTipi==2){
                        tipIndirimi=(float)(indirimliFiyat * 0.20);
                        tutar = (indirimliFiyat - tipIndirimi) * 2;
                    }
                    else{
                        tutar = indirimliFiyat;
                    }
                    System.out.println("Toplm Tutar:" + tutar + "TL");
                }
            }
        }
    }
